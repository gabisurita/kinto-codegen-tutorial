...
from swagger_client.models.batch_defaults_body import BatchDefaultsBody


class TestBatchDefaultsBody(unittest.TestCase):
    """ BatchDefaultsBody unit test stubs """
    ...
    def testBatchDefaultsBody(self):
        """
        Test BatchDefaultsBody
        """
        model = swagger_client.models.batch_defaults_body.BatchDefaultsBody()
