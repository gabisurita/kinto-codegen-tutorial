...
from swagger_client.models.batch_defaults import BatchDefaults


class TestBatchDefaults(unittest.TestCase):
    """ BatchDefaults unit test stubs """
    ...
    def testBatchDefaults(self):
        """
        Test BatchDefaults
        """
        model = swagger_client.models.batch_defaults.BatchDefaults()
