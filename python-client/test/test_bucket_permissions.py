...
from swagger_client.models.bucket_permissions import BucketPermissions
...
class TestBucketPermissions(unittest.TestCase):
    ...
    def testBucketPermissions(self):
        """
        Test BucketPermissions
        """
        model = swagger_client.models.bucket_permissions.BucketPermissions()
