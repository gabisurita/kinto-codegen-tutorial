...
class BatchDefaults(object):
    ...
    def __init__(self, method=None, path=None, body=None, headers=None):
        """
        BatchDefaults - a model defined in Swagger
    ...
    def method(self):
        """
        Gets the method of this BatchDefaults.
        HTTP method to be used on all requests.

        :return: The method of this BatchDefaults.
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """
        Sets the method of this BatchDefaults.
        HTTP method to be used on all requests.

        :param method: The method of this BatchDefaults.
        :type: str
        """
    ...
    def path(self):
        """
        Gets the path of this BatchDefaults.
        URL path to be used on all requests.

        :return: The path of this BatchDefaults.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this BatchDefaults.
        URL path to be used on all requests.

        :param path: The path of this BatchDefaults.
        :type: str
        """
    ...
    def body(self):
        """
        Gets the body of this BatchDefaults.


        :return: The body of this BatchDefaults.
        :rtype: BatchDefaultsBody
        """
        return self._body
    ...
    def body(self, body):
        """
        Sets the body of this BatchDefaults.


        :param body: The body of this BatchDefaults.
        :type: BatchDefaultsBody
        """
    ...
    def headers(self):
        """
        Gets the headers of this BatchDefaults.


        :return: The headers of this BatchDefaults.
        :rtype: dict(str, str)
        """
    ...
    def headers(self, headers):
        """
        Sets the headers of this BatchDefaults.


        :param headers: The headers of this BatchDefaults.
        :type: dict(str, str)
        """
